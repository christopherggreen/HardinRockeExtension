...
lvs.sorted <- c(
  "MCDMBP.CHI","MCDMBP.HR","MCDMBP.GM","RMCDMBP","RMCDMBP.CH",
  "MCDMBP.HR.NOSS","MCDMBP.GM.NOSS",
  "MCD75.CHI","MCD75.HR","MCD75.GM","RMCD75","RMCD75.CH",
  "MCD75.HR.NOSS","MCD75.GM.NOSS",
  "MCD95.CHI","MCD95.HR","MCD95.GM","RMCD95","RMCD95.CH",
  "MCD95.HR.NOSS","MCD95.GM.NOSS",
...
table.data <- subset( tmpout.t3$reshaped$sds010, !grepl("NOSS",Method) )
table.data$Method <- table.data$Method[drop=TRUE]
