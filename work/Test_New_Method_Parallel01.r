...
allmeans.hrsimnew01 <- allmeans
allstds.hrsimnew01 <- allstds

save("allmeans.hrsimnew01", file="allmeans.hrsimnew01.rda")
save("allstds.hrsimnew01", file="allstds.hrsimnew01.rda")
